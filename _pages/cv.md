...
_styles: >
  ...
  .container { max-width: 1000px !important; } /* 여기서 페이지 전체 너비를 직접 지정하세요 */
---
...
<div class="card mt-1" style="border: 1px solid var(--global-divider-color); overflow: hidden; border-radius: 4px;">
